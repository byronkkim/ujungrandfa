...
- 적을 물리치면 **10% 확률**로 아군 탱크 합류(최대 10대). 아군은 나를 따라다니며 **내 뒤쪽만** 사격, 서로 겹침
- 아군 탱크도 **체력 20**: 적·보스와 부딪히면 1(0.5초에 한 번), 보스 미사일은 3씩 깎이고 0이 되면 격파되어 사라진다. 다친 아군만 머리 위에 체력 막대 표시. **단계를 넘어가면 체력이 다시 꽉 찬다**
