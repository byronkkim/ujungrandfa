...
- 🎓 **튜토리얼 모드**(시작 화면 체크박스): 이동→점프→공격→필살기→별→보스 순으로 화면 위에 안내가 뜨고, 직접 해내면 다음 단계로 넘어간다. 고른 단계를 깰 수 있게 하트 10, 구멍·용암에 빠져도 하트 유지, 적 체력 1, 보스는 1단계 세기, **앞에 적이 있으면 자동으로 사격**. 고수 모드와 동시 선택 불가
